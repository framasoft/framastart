  ...
  <body>
	...
	<div class="oslibre well">
		<h2>Et si vous passiez à GNU/Linux ?</h2>
			...
			<p>Linux est un <em>système d'exploitation</em>, un logiciel important qui contrôle un ordinateur. Il est semblable à Microsoft Windows, mais il est entièrement libre. Le vrai nom est <em>GNU/Linux</em>, mais "Linux" convient aussi.</p>
...
<!-- ---------------------- Fenêtres modales ------------------------------------------ -->
    ...
    <div class="modal hide" id="framasoft">
	  ...
	  <div class="modal-body">
		...
		<p>Issu du monde éducatif, <strong>Framasoft</strong> est un réseau de sites web collaboratifs à géométrie variable dont le dénominateur commun est le logiciel libre, sa culture et son état d'esprit. Il vise à diffuser le logiciel libre et à le faire connaître auprès du plus large public.</p>
    ...
    <div class="modal hide fade" id="about">
	  ...
	  <div class="modal-body">
		<p>
			Cette sélection de logiciels libres vous est proposée, sur l'impulsion de <a href="http://unpidf.univ-paris1.fr/">l'Université Numérique Régionale Paris Île-de-France</a> en partenariat avec l'association <a href="http://framasoft.org">Framasoft</a>.</p>
			Issu du monde éducatif, <strong>Framasoft</strong> est un réseau de sites web collaboratifs à géométrie variable dont le dénominateur commun est le logiciel libre, sa culture et son état d'esprit. Il vise à diffuser le logiciel libre et à le faire connaître auprès du plus large public.
		</p>
		<p>
    ...
    <div class="modal hide fade" id="libre">
	  ...
	  <div class="modal-body">
		...
		<p>
			Pour en apprendre plus sur ce mouvement social, et non seulement technique, vous pouvez vous référer au <a href="http://framabook.org/richard-stallman-et-la-revolution-du-logiciel-libre" alt="Framabook RMS">Framabook "Richard Stallman et la révolution du logiciel libre"</a>.<br />
