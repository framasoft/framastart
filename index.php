			...
			<div class="thumbnails span2">
			  ...
			  <div class="span10">
			    ...
			    <div class="complements"><a class="btn btn-success btn-large" href="http://www.zotero.org/">Site officiel</a>
			    	<span class="alert alert-success"><strong>Astuce : </strong>Zotero existe aussi en tant qu'<a href="https://www.zotero.org/download/" title="extension Zotero pour navigateurs">extension pour navigateurs</a>.</span>
			    </div>
			  </div>
		</div>
			...
			<div class="thumbnails span2">
			  ...
			  <div class="span10">
			    ...
			    <div class="complements"><a class="btn btn-success btn-large" href="http://www.latex-project.org/">Site officiel</a>
			    	<span class="alert alert-success"><strong>Astuce : </strong>Vous pouvez consulter l'ouvrage libre <a href="https://framabook.org/tout-sur-latex/" title="Framabook LaTeX">"Tout (...) sur LaTeX"</a> dans la collection Framabook.</span>
...
<p><small><em>Texte issu du site <a href="http://www.getgnulinux.org/fr/switch_to_linux/">site getgnulinux.org</a>, licence CC-BY-SA version 2.0 ou ultérieure</em></small></p>
		...
		<h2>Obtenir de l'aide</h2>
			...
			<p> Par ailleurs, si vous avez besoin d'aide à l'installation de GNU/Linux ou dans la prise en main des logiciels, sachez qu'il existe de nombreux <a href="http://aful.org/gul/" title="liste des GUL">Groupes d'Utilisateurs de Logiciels Libres</a> (GULL) : .</p>
    ...
    <div class="modal hide fade" id="libre">
	  ...
	  <div class="modal-body">
	  	...
	  	<p>Le mouvement du logiciel libre est constitué de nombreuses institutions (essentiellement des fondations, associations ou groupement d'entreprises), chacune avec ses spécificités. Il est parfois difficile de s'y retrouver, c'est pourquoi nous vous en communiquons une liste non-exhaustive :
	  		<ul>
	  			<li><a href="http://april.org" title="site web">April</a> (promotion et défense du logiciel libre)</li>
	  			<li><a href="http://aful.org" title="site web">AFUL</a> (association Française des utilisateurs de logiciels libres)</li>
	  			<li><a href="http://dogmazic.net" title="site web">Dogmazic</a> (promotion de la musique libre)</li>
	  			<li><a href="http://framablog.org" title="site web">Framablog</a> (site d'information sur le mouvement du logiciel libre, et ce qu'il change dans la société actuelle)</li>
	  			<li><a href="http://fsf.org" title="site web">FSF</a> (Free Software Foundation, en anglais)</li>
	  			<li><a href="http://formats-ouverts.org" title="site web">Formats-ouverts</a> (site d'informations sur la problématique des formats ouverts)</li>
	  			<li><a href="http://linuxfr.org" title="site web">Linuxfr</a> (site d'information - parfois technique - autour de GNU/Linux et du logiciel libre)</li>
	  			<li><a href="http://libreacces.org" title="site web">Libre Accès</a> (promotion de la Culture libre)</li>
	  			<li><a href="http://laquadrature.net" title="site web">La Quadrature du Net</a> (information et défense sur le sujet des libertés - numériques, mais pas seulement)</li>
	  			<li><a href="http://wikimedia.fr" title="site web">Wikimédia France</a> (chapitre français de la Wikimédia Foundation, qui structure notamment le projet d'enclyclopédie Wikipédia)</li>
	  		</ul>
	  	</p>
	  	...
	  	<p>Pour en apprendre plus sur ce mouvement social, et non seulement technique, vous pouvez vous référer au <a href="http://framabook.org/richard-stallman-et-la-revolution-du-logiciel-libre" title="Framabook RMS">Framabook "Richard Stallman et la révolution du logiciel libre"</a>.<br />
