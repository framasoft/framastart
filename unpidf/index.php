...
<html lang="fr">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse">
			...
			<ul class="nav">
	              ...
	              <li><a href="#education"><i class="icon-pencil"></i> Education supérieure</a></li>
    ...
    <div class="container">
     	<div style="float:right;"><a href="http://www.universitenumerique-paris-idf.fr/"><img src="logos/logo_UNR.jpg" alt="UNR Paris Île-de-France"/></a></div>
      <div class="hero-unit">
	...
	<div id="listesofts">
		...
		<div class="span12">
			<div class="thumbnails span2">
			  ...
			  <div class="span10">
			  	<h3>Pidgin</h3>
			    <div class="fonction">Messagerie instantannée</div>
			    <div class="description">Messagerie instantannée (tchat) multiprotocole (compatible MSN, Yahoo!, Google Talk, IRC, etc)</div>
		...
		<div class="span12">
			<div class="thumbnails span2">
			  ...
			  <div class="span10">
			    ...
			    <div class="complements"><a class="btn btn-success btn-large" href="">Site officiel</a></div>
			  </div>
		</div>	
		...
		<div class="span12">
			<div class="thumbnails span2">
			      <img src="/logos/pdfcreator_icon.png" alt="">
			  </div>
			  <div class="span10">
			  	<h3>PDFCreator</h3>
			    <div class="fonction">Création de PDF</div>
			    <div class="description">Transformez n'importe quel document en fichier PDF. PDFCreator ajoute une imprimante virtuelle à votre système Windows. Tout ce que vous y "imprimerez" sortira sous la forme d'un document PDF.</div>
			    <div class="complements"><a class="btn btn-success btn-large" href="http://www.pdfforge.org/">Site officiel</a>
			    	...
			    	<span class="alert alert-warning"><strong>Attention : </strong>nous vous encourageons à décocher l'option "PFDForge Toolbar" lors de l'installation.</span>
			    </div>
			  </div>
		</div>
	...
	<div class="oslibre well">
		<h2>Et si vous passiez à GNU/Linux ?</h2>
			...
			<p>Le mot Linux vous évoque peut-être des programmeurs barbus tapant du code obscur sur un écran noir. Bonne nouvelle ! Les choses ont changées.</p>
...
<p>Tout ce qui est produit est placé sous licence libre, favorisant ainsi la participation et garantissant que le travail effectué demeurera sans appropriation au bénéfice de tous.</p>
    ...
    <div class="modal hide fade" id="about">
	  ...
	  <div class="modal-body">
	  	<p>Cette sélection de logiciels libres vous est proposée, sur l'impulsion de <a href="http://www.universitenumerique-paris-idf.fr/">l'Université Numérique Régionale Paris Île-de-France</a> en partenariat avec l'association <a href="http://framasoft.org">Framasoft</a>.</p>
Issu du monde éducatif, <strong>Framasoft</strong> est un réseau de sites web collaboratifs à géométrie variable dont le dénominateur commun est le logiciel libre, sa culture et son état d'esprit. Il vise à diffuser le logiciel libre et à le faire connaître auprès du plus large public.</p>
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-896440-21']);
  _gaq.push(['_setDomainName', 'framastart.org']);
